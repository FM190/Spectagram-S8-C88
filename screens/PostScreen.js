            ...
            return (
                <View style={this.state.lighttheme?styles.lightcontainer:styles.darkcontainer}>
                    ...
                    <View style={styles.postContainer}>
                        <ScrollView style={this.state.lighttheme?styles.lightpostCard:styles.darkpostCard}>
                            <View style={styles.authorContainer}>
                                ...
                                <View style={styles.authorNameContainer}>
                                    <Text style={this.state.lighttheme?styles.lightauthorNameText:styles.darkauthorNameText}>{this.props.route.params.author}</Text>
                                </View>
                            </View>
